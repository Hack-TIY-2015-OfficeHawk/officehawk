...
class AlertsControllerTest < ActionController::TestCase
  ...
  test "should create alert" do
    assert_difference('Alert.count') do
      post :create, alert: { beacon: @alert.beacon, duration: @alert.duration, employee_id: @alert.employee_id, state: @alert.state }
    end
  ...
  test "should update alert" do
    patch :update, id: @alert, alert: { beacon: @alert.beacon, duration: @alert.duration, employee_id: @alert.employee_id, state: @alert.state }
    assert_redirected_to alert_path(assigns(:alert))
  end
